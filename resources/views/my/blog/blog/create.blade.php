        ...
        <div class="card shadow">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('blog.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="s_description">Short Description <span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    <label>Blog Photo <span class="text-danger">*</span></label>
                    <input type="file" id="blog_photo" class="form-control" name="blog_photo">
                </div>

                <div class="form-group">
                    <label for="editors_comment ">Editors Comment <span class="text-danger">*</span></label>
