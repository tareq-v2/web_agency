...
@section('breadcrumb')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item ">
                <a href="{{ route('dashboard') }}">View Service</a>
            </li>
            ...
            <div class="card-body">
                <form class="form form-vertical" action="{{ route('service_edit_insert', $single_service_data->id) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="email">Service Title</label>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="password">Service Details</label>
                        ...
                        @endforeach
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary mr-1">Edit Services</button>
                        </div>
                    </div>
                </form>
            </div>
