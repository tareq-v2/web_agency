...
@section('breadcrumb')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item ">Section 7</li>
    ...
    <div class="col-9">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            @foreach ($datas as $data)
                    <li class="nav-item">
                        <a class="nav-link {{ $loop->first ? "active" : "" }}" id="pills-tab-{{ $data->id }}" data-toggle="pill" href="#pills-{{ $data->id }}" role="tab" aria-controls="pills-{{ $data->id }}" aria-selected="{{ $loop->first ? "true" : "false" }}">Block {{ $data->id }}</a>
                    </li>
            @endforeach
        </ul>
    </div>
    <div class="col-3 text-right">
        <a class="btn btn-info" href="{{ route('button.index') }}">Update Common Button</a>
    </div>
</div>
<div class="card">
    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group">
                                            <label for="image">Background Icon<span class="text-danger">  *</span></label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="buy_now_link">Buy Now Link<span class="text-danger">  *</span></label>
