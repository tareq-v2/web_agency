            ...
            <div class="card shadow">
                <div class="card-header d-flex py-4">
                    <div>
                        ...
                        <p class="card-text"><a href="{{ route('contact_us.index') }}">Total Messages</a></p>
          ...
          <div class="card shadow">
                <div class="card-header d-flex py-4">
                    <div>
                        ...
                        <p class="card-text"><a href="{{ route('service.index') }}">Total Services</a></p>
                    </div>
                    <div class="avatar bg-light-primary">
                        <div class="avatar-content">
          ...
          <div class="card shadow">
                <div class="card-header d-flex py-4">
                    <div>
                        ...
                        <a href="{{ route('testimonial.index') }}">Total Testimonials</a>
                    </div>
                    <div class="avatar bg-light-primary">
                        <div class="avatar-content">
          ...
          <div class="card shadow">
                <div class="card-header d-flex py-4">
                    <div>
                        ...
                        <a href="{{ route('team.index') }}">Total Team</a>
                    </div>
                    <div class="avatar bg-light-primary">
                        <div class="avatar-content">
          ...
          <div class="card shadow">
                <div class="card-header d-flex py-4">
                    <div>
                        ...
                        <a href="{{ route('blog.index') }}">Total Blog</a>
                    </div>
                    <div class="avatar bg-light-primary">
                        <div class="avatar-content">
          ...
          <div class="card shadow">
                <div class="card-header d-flex py-4">
                    <div>
                        ...
                        <a href="{{ route('gallery.index') }}">Total Gallery</a>
                    </div>
                    <div class="avatar bg-light-primary">
                        <div class="avatar-content">
