...
<div class="breadcrumb-wrapper">
   <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active">Update Contact Us Top Section</li>
   </ol>
</div>
@endsection
    ...
    <div class="col-lg-12">
      <div class="card shadow">
        <div class="card-header">
                  <h4 class="card-title">Edit Contact Us Top Section</h4>
                </div>
                <div class="card-body">
                  <form action="{{ route('contact_us.update', $all_contactus_data->id) }}" method="POST" enctype="multipart/form-data">               
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label  for="title">Phone one <span class="text-danger">*</span></label>
                      ...
                      <div class="form-group">
                        <label  for="title">Phone two</label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label  for="title">Email one <span class="text-danger">*</span></label>
                      ...
                      <div class="form-group">
                        <label  for="title">Email Two</label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label  for="title">Address line one<span class="text-danger">*</span></label>
                      ...
                      <div class="form-group">
                        <label  for="contact_address_two">Address line two </label>
