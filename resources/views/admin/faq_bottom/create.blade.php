...
@section('breadcrumb')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Create Faq Bottom Section</li>
        </ol>
    </div>
@endsection
            ...
            <div class="col-lg-12">
              <div class="card shadow">
                <div class="card-header">
                  <h4 class="card-title">Create Faq Bottom </h4>
                </div>
                <div class="card-body">
                  <form action="{{ route('faq_unanswer.update', $faq_unanswer_data->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                          <label  for="icon">Background Image <span class="text-danger">*</span></label>
