...
@section('breadcrumb')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Update General Settings</li>
        </ol>
    </div>
@endsection
                ...
                <form class="form form-vertical" action="{{ route('generalSettings.update', $get_generel_settings_data->id) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="name">preview Icon</label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="common_button_text">Arrow Icon <span class="text-danger">*</span> </label> [  <span><a href="https://fontawesome.com/icons" target="_blank">Click Here</a> for icon ]</span>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="copyright">Copyright ( &copy; ) <span class="text-danger">*</span></label>
