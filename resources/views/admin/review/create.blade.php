            ...
            <div class="card-body">
                <form class="form form-vertical" action="{{ route('review.store') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="password">Customer Name <span class="text-danger"> *</span></label>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="password">Customer Comment <span class="text-danger"> *</span></label>
                        ...
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary mr-1">Add Review</button>
                        </div>
                    </div>
                </form>
            </div>
