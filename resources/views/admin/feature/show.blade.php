...
<section class="banner-main-section py-5 all-pages-input" id="main">
    <div class="row">
        <div class="col-12">
            <h2 class="dash-ad-title m-0 mb-3">Admin Dashboard | <span class="dash-span-title">Show Feature Single Data</span></h2>
        </div>
    </div>
    <div class="container">
        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="table-responsive">
                                            ...
                                            <a class="btn mt-1 btn-success" href="{{ route('feature.index') }}">Return Back</a>
