...
@section('breadcrumb')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item ">Section 8</li>
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('startProject.update', $data->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="meta_title"> Short Description <span class="text-danger">  *</span></label>
                                    <textarea type="text" name="meta_title" id="" cols="30" rows="5" class="form-control">{{ $data->meta_title }}</textarea>
                            </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="button_text">Button<span class="text-danger"> *</span></label>
