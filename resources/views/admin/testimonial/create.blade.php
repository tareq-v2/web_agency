                  ...
                  <form action="{{ route('testimonial.store') }}" method="POST" enctype="multipart/form-data">               
                    @csrf
                      ...
                      <div class="form-group">
                        <label  for="icon">User Name <span class="text-danger">*</span> </label>
                      ...
                      <div class="form-group">
                        <label  for="icon">User Review <span class="text-danger">*</span></label>
                      ...
                      <div class="form-group">
                        <label  for="icon">User Photo <span class="text-danger">*</span></label>
