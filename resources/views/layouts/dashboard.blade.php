            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item">
                    <a class="d-flex align-items-center" href="#">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Menu Levels">Home</span>
                    </a>
                    <ul class="menu-content">
                        <li>
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-item text-truncate" data-i18n="Second Level">Banners</span>
                            </a>
                            <ul class="menu-content">
                        ...
                        <li class="@yield('companyList')">
                            <a class="d-flex align-items-center" href="{{ route('company.index') }}">
                                ...
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="List">Section 2</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Second Level">Section 4 (Process)</span>
                            </a>
                            <ul class="menu-content">
                        ...
                        <li class="@yield('marketList')">
                            <a class="d-flex align-items-center" href="{{ route('m_stretegy.index') }}">
                                @yield('marketSpinner')
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="List">Section 6</span>
                            </a>
                        </li>
                        ...
                        <li class=" nav-item @yield('buyNowList')">
                            <a class="d-flex align-items-center" href="{{ route('buyNow.index') }}">
                                @yield('buySpinner')
                                <i data-feather='circle'></i>
                                <span class="menu-title text-truncate" data-i18n="Invoice">Section 7</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center" href="#">
                                @yield('reviewSpinner')
                                <i data-feather='circle'></i>
                                <span class="menu-title text-truncate" data-i18n="Invoice">Review</span>
                            </a>
                            <ul class="menu-content">
                        ...
                        <li class=" nav-item @yield('startProjectList')">
                            <a class="d-flex align-items-center" href="{{ route('startProject.index') }}">
                                ...
                                <i data-feather='circle'></i>
                                <span class="menu-title text-truncate" data-i18n="Invoice">Start Project</span>
                            </a>
                        </li>
                    ...
                    <ul class="menu-content">
                        <li class="@yield('about_header')">
                            <a class="d-flex align-items-center" href="{{ route('about_header') }}">
                                ...
                                <span class="menu-item text-truncate" data-i18n="List">Header Section</span>
                            </a>
                        </li>
                        <li class="@yield('about_us')">
                            <a class="d-flex align-items-center" href="{{ route('about_us') }}">
                                <i data-feather="circle" class="@yield('aboutUs')"></i>
                                <span class="menu-item text-truncate" data-i18n="Add">About Us</span>
                            </a>
                        </li>
                        <li class="@yield('about_back_img')">
                            <a class="d-flex align-items-center" href="{{ route('about_back_img') }}">
                                ...
                                <span class="menu-item text-truncate" data-i18n="Add">Team Section</span>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="@yield('blogcomment')">
                            <a class="d-flex align-items-center" href="{{ route('blogcomment.index') }}">
                                ...
                                <span class="menu-item text-truncate" data-i18n="List">Comments</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item">
                    <a class="d-flex align-items-center" href="#">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Invoice">Team</span>
                    </a>
                    <ul class="menu-content">
                ...
                <li class=" nav-item">
                    <a class="d-flex align-items-center" href="#">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Invoice">Testimonials</span>
                    </a>
                    <ul class="menu-content">
                    ...
                    <ul class="menu-content">
                        <li class="@yield('FaqTopCreate')">
                            <a class="d-flex align-items-center" href="{{ route('faq_top.create') }}">
                                ...
                                <span class="menu-item text-truncate" data-i18n="Add">Faq Top Create</span>
                            </a>
                        </li>
                        ...
                        <li class="@yield('FaqUnanserCreate')">
                            <a class="d-flex align-items-center" href="{{ route('faq_unanswer.create') }}">
                                ...
                                <span class="menu-item text-truncate" data-i18n="Add">Faq Bottom Create</span>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a class="d-flex align-items-center" href="#">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Invoice">Features</span>
                    </a>
                    <ul class="menu-content">
                ...
                <li class="nav-item">
                    <a class="d-flex align-items-center" href="#">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Invoice">Gallery</span>
                    </a>
                    <ul class="menu-content">
                        <li class="@yield('gallery_name')">
                            <a class="d-flex align-items-center" href="{{ route('gallery_name.index') }}">
                                ...
                                <span class="menu-item text-truncate" data-i18n="List">Gallery Name</span>
                            </a>
                        </li>
                        <li class="@yield('gallery')">
                            <a class="d-flex align-items-center" href="{{ route('gallery.index') }}">
                                ...
                                <span class="menu-item text-truncate" data-i18n="List">Gallery</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item">
                    <a class="d-flex align-items-center" href="#">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Invoice">Contact Us</span>
                    </a>
                    <ul class="menu-content">
                ...
                <li class="@yield('ContactMessageList')">
                    <a class="d-flex align-items-center" href="{{ route('contact_us.index') }}">
                        ...
                        <span class="menu-item text-truncate" data-i18n="List">Contact Message</span>
                    </a>
                </li>
                ...
                <li class="nav-item @yield('titlelSettings')">
                    ...
                    <a class="d-flex align-items-center" href="{{ route('titleSettings.index') }}">
                        ...
                        <i data-feather='settings'></i>
                        <span class="menu-title text-truncate">Title Settings</span>
                    </a>
                </li>
